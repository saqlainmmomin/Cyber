...
def generate_evidence_checklist_pdf(
    ...
    pdf.set_y(15)
    pdf.set_x(PM)
    pdf.multi_cell(CW, 8, text=S(f"{settings.firm_name} Evidence Request"), align="C")
    ...
    pdf.multi_cell(CW, 5, text=S(
        f"This evidence request was generated by {settings.firm_name}. "
...
def generate_evidence_checklist_docx(
    ...
    # Title
    title = doc.add_heading(f"{settings.firm_name} Evidence Request", level=1)
