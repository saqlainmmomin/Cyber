...
_GUIDANCE_TEXT = {
    ...
    "CH2.CONSENT.2": "Section 6(1) requires consent to be specific to the specified purpose and limited to the personal data necessary for it. Look for itemised consent prompts that clearly distinguish purposes, evidence that bundled or combined consent is not used, and records showing which specific purposes each Data Principal consented to.",
    ...
    "CH2.NOTICE.1": "Section 5(1) requires every consent request to be accompanied or preceded by a notice stating the personal data and purpose, how to withdraw consent and exercise rights, and how to complain to the Board. DPDP Rules 2025 r.3 sets its content and form.",
    ...
    "CH2.MINIMIZE.3": "Section 8(7) requires erasure once the purpose is served; documented retention schedules with systematic deletion procedures are how that is met. Look for a retention policy defining retention periods per data category, deletion workflows, and evidence that schedules are reviewed and approved.",
