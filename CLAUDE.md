...
**Current phase:** Phase 1 — Schema & Hierarchy. P1-1/P1-2/P1-6 merged (PRs #16-#18); P1-3 implemented, PR #19 open awaiting merge; P1-4/P1-5 not started — see `tasks/todo.md`.
