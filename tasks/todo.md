...
- [ ] **Phase 4 — AWS & validation** `[AR: IAM/external ID, retention/purge, performance]` — P4-1, P4-2 and P4-3 implementation complete; review Results in [`2026-09-24-p4-1-aws-evidence-adapter.md`](tasks/handoffs/2026-09-24-p4-1-aws-evidence-adapter.md), [`2026-09-24-p4-2-longitudinal-demo.md`](tasks/handoffs/2026-09-24-p4-2-longitudinal-demo.md) and [`2026-09-24-p4-3-performance-benchmarks.md`](tasks/handoffs/2026-09-24-p4-3-performance-benchmarks.md). P4-4 is the most destructive code path in the plan. Kickoff process doc: `tasks/handoffs/2026-09-24-phase-4-kickoff.md`.
