...
- [ ] **P2-4: Consultant conclusion approval workflow** `[AR: individual-only approvals, optimistic locking]` — implementation in progress from the fixed decisions and contract scenarios in `tasks/handoffs/2026-09-23-p2-4-consultant-approval.md`; Results will be recorded in that handoff before completion.
