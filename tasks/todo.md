...
- [x] **P2-3: Immutable analysis pipeline** — implemented and verified: 29 contract tests and 392 full-suite tests pass; dual-written append-only runs/conclusions/revisions, guarded Alembic migration, citation memoization, legacy migration coexistence, and isolated ASGI re-run smoke completed. Handoff Results appended to `tasks/handoffs/2026-09-23-p2-3-immutable-analysis-pipeline.md`.
